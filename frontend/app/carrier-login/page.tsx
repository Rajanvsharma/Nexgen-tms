  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.user.role !== 'CARRIER') {
        setError('This portal is for carriers only. Use the main login.');
        return;
      }
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: 13, marginTop: 4 }}>Carrier Portal</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 13, marginBottom: 24 }}>View loads, documents & manage your profile</div>

          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: 'block', color: 'rgba(255,255,255,0.6)', fontSize: 12, fontWeight: 600, marginBottom: 6, letterSpacing: '0.3px' }}>EMAIL ADDRESS</label>
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@carrier.com" style={inputStyle} />
            </div>
            <div style={{ marginBottom: 20 }}>
              <label style={{ display: 'block', color: 'rgba(255,255,255,0.6)', fontSize: 12, fontWeight: 600, marginBottom: 6, letterSpacing: '0.3px' }}>PASSWORD</label>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              color: '#fff', border: 0, borderRadius: 10, fontSize: 15, fontWeight: 700,
        ...
        <div style={{ textAlign: 'center', marginTop: 20, color: 'rgba(255,255,255,0.25)', fontSize: 12 }}>
          Internal staff?&nbsp;<a href="/login" style={{ color: '#fbbf24', textDecoration: 'none' }}>Use the main login →</a>
        </div>
      </div>
    </div>
  );
